...
To build the final jar and optimize the AbsaUGDTScheduler application for production, run:
...
Then navigate to [http://localhost:1690](http://localhost:1690) in your browser.
